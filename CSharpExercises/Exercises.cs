...
namespace CSharpExercises
{
    public static class Exercises
    {
        ...
        public static string GetFirstName(string aName)
        {
            string[] newArray = aName.Split(' ');
            return newArray[0];
        }
        ...
        public static string ReverseStringHard(string a)
        {
            string newString = "";
        ...
        {
            double fTemp = kTemp * (9.0 / 5.0) - 459.67;
            return Math.Round(fTemp, 2);
        }
        ...
        public static double GetAverageHard(int[] a)
        {
            ...
            double average = arrTotal / a.Length;
            return average;
        }
         ...
         * 88
         * 8 */
        public static string DrawTriangle(int a, int b)
        {
            string triangle = "";
            int rows = b;
        ...
        public static bool IsVowel(char t)
            {
            bool vowel = false;
        ...
        {
            int days = 7;
            DateTime[] nextDays = new DateTime[days];
